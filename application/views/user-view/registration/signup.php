 ...
 <div class="hero-wrap hero-bread" style="background-image: url('<?php echo SITE_ASSETS_PATH; ?>banner/bg_6.jpg');">
    ...
    <section class="ftco-section">
      ...
      <p id="error_msg"></p>
			...
			<hr class="colorgraph">
			<div class="row">
				<div class="col-xs-12 col-md-6"><input type="submit" value="Register" id="regsavebtn" class="btn btn-primary btn-block btn-lg" tabindex="7"></div>
...
<!-- Modal -->
<div class="modal fade" id="t_and_c_m" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        ...
        <button type="button" class="btn btn-secondary" data-dismiss="modal">I Don't</button>
        <span class="button-checkbox">
