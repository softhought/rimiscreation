            ...
            <div class="card">
              <div class="card-header">
                ...
                <div class="btn-group btn-group-sm float-right" role="group" aria-label="MoreActionButtons" >
                  <a href="<?php echo ADMIN_BASE_PATH; ?>brand/create" class="btn btn-info btnpos link_tab">
              ...
              <table id="example2" class="table table-bordered table-hover dataTable">
                ...
                <tbody>                       
                    ...
                    foreach ($bodycontent['BrandList'] as $brand) { ?> 
                        <tr>
                        <td><?php echo $brand->Name; ?> </td>
                        <td style="text-align: center;">
                            <?php if ($brand->Logo!="") {?>                            
                                <img src="<?php echo ASSETS_PATH.'brand-logo/',$brand->Logo; ?>" style="width: 23px;height: 23px;" alt="active icon">
                            <?php } ?>
                        </td>

                        <td style="text-align: center;">
                            <?php  if ($brand->IsActive=='Y') { ?>
                                <!-- <a title="Active" href="<?php echo ADMIN_BASE_PATH;?>user/InactiveUser/<?php echo $brand->BrandId; ?>"> -->
                                    <img src="<?php echo ASSETS_PATH; ?>img/tick.png" style="width: 23px;height: 23px;" alt="active icon">
                                <!-- </a>                                 -->
                            <?php }else{ ?>
                                <!-- <a title="Inactive" href="<?php echo ADMIN_BASE_PATH;?>user/ActiveUser/<?php echo $brand->BrandId; ?>"> -->
                        ...
                        <td style="text-align: center;">
                          <a title="Edit" href="<?php echo ADMIN_BASE_PATH; ?>brand/edit/<?php echo $brand->BrandId; ?>" class="btn btn-sm  btn-outline-info">
