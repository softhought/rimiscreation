            ...
            <div class="card">
              <div class="card-header">
                ...
                <div class="btn-group btn-group-sm float-right" role="group" aria-label="MoreActionButtons" >
                  <a href="<?php echo ADMIN_BASE_PATH; ?>subcategory/create" class="btn btn-info btnpos link_tab">
              ...
              <table id="example2" class="table table-bordered table-hover dataTable">
                ...
                <tbody>                       
                    ...
                    foreach ($bodycontent['subCategoryList'] as $category) { ?> 
                        <tr>
                        <td><?php echo $category->SubCatDesc; ?> </td>
                        ...
                        <td style="text-align: center;">
                            <?php  if ($category->IsActive=='Y') { ?>
                                <!-- <a title="Active" href="<?php echo ADMIN_BASE_PATH;?>user/InactiveUser/<?php echo $category->SubCategoryId; ?>"> -->
                                    <img src="<?php echo ASSETS_PATH; ?>img/tick.png" style="width: 23px;height: 23px;" alt="active icon">
                                <!-- </a>                                 -->
                            <?php }else{ ?>
                                <!-- <a title="Inactive" href="<?php echo ADMIN_BASE_PATH;?>user/ActiveUser/<?php echo $category->SubCategoryId; ?>"> -->
                        ...
                        <td style="text-align: center;">
                          <a title="Edit" href="<?php echo ADMIN_BASE_PATH; ?>subcategory/edit/<?php echo $category->SubCategoryId; ?>" class="btn btn-sm  btn-outline-info">
