            ...
            <div class="card">
              <div class="card-header">
                ...
                <div class="btn-group btn-group-sm float-right" role="group" aria-label="MoreActionButtons" >
                  <a href="<?php echo ADMIN_BASE_PATH; ?>vendor/create" class="btn btn-info btnpos link_tab">
              ...
              <table id="example2" class="table table-bordered table-hover dataTable">
                ...
                <tbody>                       
                    ...
                    foreach ($bodycontent['VendorList'] as $vendor) { ?> 
                        <tr>
                        <td><?php echo $vendor->Name; ?> </td>
                        <td><?php echo $vendor->Address; ?></td>
                        <td><?php echo $vendor->BusinessName; ?></td>
                        <td><?php echo $vendor->BusinessAddress; ?></td>
                        <td><?php echo $vendor->GstNo; ?></td>
                        <td><?php echo $vendor->PanNo; ?></td>

                        <td style="text-align: center;">
                            <?php  if ($vendor->IsActive=='Y') { ?>
                                <!-- <a title="Active" href="<?php echo ADMIN_BASE_PATH;?>user/InactiveUser/<?php echo $vendor->VendorId; ?>"> -->
                                    <img src="<?php echo ASSETS_PATH; ?>img/tick.png" style="width: 23px;height: 23px;" alt="active icon">
                                <!-- </a>                                 -->
                            <?php }else{ ?>
                                <!-- <a title="Inactive" href="<?php echo ADMIN_BASE_PATH;?>user/ActiveUser/<?php echo $vendor->VendorId; ?>"> -->
                        ...
                        <td style="text-align: center;">
                          <a title="Edit" href="<?php echo ADMIN_BASE_PATH; ?>vendor/edit/<?php echo $vendor->VendorId; ?>" class="btn btn-sm  btn-outline-info">
