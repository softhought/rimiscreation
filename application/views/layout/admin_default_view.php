...
<head>
  ...
  <!-- summernote -->
  <link rel="stylesheet" href="<?php echo ASSETS_PATH; ?>plugins/summernote/summernote-bs4.css">
  <!-- Google Font: Source Sans Pro -->
  <link href="https://fonts.googleapis.com/css?family=Source+Sans+Pro:300,400,400i,700" rel="stylesheet">
  <!-- Ekko Lightbox -->
  <link rel="stylesheet" href="<?php echo ASSETS_PATH; ?>plugins/ekko-lightbox/ekko-lightbox.css">
   <!-- DataTables -->
 ...
 <!-- Bootstrap Select -->
 <link rel="stylesheet" href="<?php echo ASSETS_PATH; ?>css/bootstrap-select.css">
 <!-- Select 2-->
 <link rel="stylesheet" href="<?php echo ASSETS_PATH; ?>plugins/select2/css/select2.css">
...
.select-smll .btn-light {
    
    height: calc(1.9rem + 2px) !important;
    font-size: 14px !important;
}
.select-smll .dropdown-menu{
  font-size: 14px !important;
}
...
<div class="wrapper">
    ...
    <ul class="navbar-nav ml-auto">
      ...
      <li class="nav-item ">       
        <a  href="<?php echo base_url();?>admin/Logout">
          <img class="nav-link" src="<?php echo ASSETS_PATH; ?>img/power.png" alt="log out">
        </a>       
      </li>
      <!-- <li class="nav-item">
  ...
  <aside class="main-sidebar sidebar-dark-lightblue elevation-4">
    ...
    <a href="index3.html" class="brand-link navbar-navy">
      <!-- <img src="<?php echo ASSETS_PATH; ?>/img/logo.jpg" alt="logo" class="brand-image img-circle elevation-3" style="opacity: .8"> -->
      <span class="brand-text font-weight-light">Rimi's Creations</span>
    </a>
            ...
            foreach($menu as $firstlevel){  
              if(sizeof($firstlevel['secondLevelMenu'])>0){?>
                      ...
                      <li class="nav-item">
                        ...
                        <ul class="nav nav-treeview">
                          <?php foreach($second_lvl['thirdLevelMenu'] as $third_lvl){ ?>
                            <li class="nav-item">
                              <a class="nav-link" href="<?php echo(ADMIN_BASE_PATH.$third_lvl['third_menu_link']); ?>">
                              <i class="far fa-circle nav-icon"></i>
                        ...
                        <?php }else{ ?>
                        <li>
                          <a class="nav-link" href="<?php echo(ADMIN_BASE_PATH.$second_lvl['second_menu_link']); ?>">
                            <i class="far fa-circle nav-icon"></i>
                ...
                <li>
                  ...
                  <a href="<?php echo ADMIN_BASE_PATH.$firstlevel['menu_link']; ?>" class="nav-link">
                    <i class="nav-icon fas fa-tachometer-alt"></i>
                    <p>
                    <?php echo $firstlevel['menu_name']; ?>
                    </p>
  ...
  <input type="hidden" value="<?php echo base_url().'admin/';?>" id="AdminBaseUrl">
...
<!-- Ekko Lightbox -->
<script src="<?php echo ASSETS_PATH; ?>plugins/ekko-lightbox/ekko-lightbox.min.js"></script>
...
<!-- Bootstrap Select -->
<script src="<?php echo ASSETS_PATH; ?>js/bootstrap-select.js"></script> 
...
<!-- AdminLTE App -->
<script src="<?php echo ASSETS_PATH; ?>dist/js/adminlte.js"></script>



<!-- AdminLTE dashboard demo (This is only for demo purposes) -->
<script src="<?php echo ASSETS_PATH; ?>dist/js/pages/dashboard.js"></script>
...
<script>
  $(document).ready(function() {
    ...
    $('.textarea-editor-simple').summernote({
      toolbar: [
